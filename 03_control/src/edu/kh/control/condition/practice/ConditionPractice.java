...
public class ConditionPractice {
     ...
     public void practice3() {
        ...
        Scanner sc = new Scanner(System.in);
 		...
 		case 1 : case 3 : case 5 : case 7 : case 8 : case 10 : case 12 :
 			 System.out.println(month + "월은 31일 까지있습니다.");
 			  break;
 			  
 		case 4 : case 6 : case 9 : case 11:
 		     System.out.println(month + "월은 30일 까지있습니다.");     
 		     break;
 		
 		case 2:
 			System.out.println(month + "월은 28일 까지있습니다.");
 			break;
    ...
    // 몸무게(kg)를 입력해주세요 :
     ...
     public void practice5() {
	   ...
	   double midTerm = sc.nextInt(); // int로 입력 받아도 대입 연산시 double 자동 형변환
