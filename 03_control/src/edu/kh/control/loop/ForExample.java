...
public class ForExample {
	...
	/*
	 * for문 - 끝이 정해져있는 경우 사용하는 반복문 ex) 10번 뛰세요. (반복 횟수가 지정되어 있는 경우)
	 * 
	 * [작성법]
	 * 
	 * for( 초기식 ; 조건식 ; 증감식 ){ 조건식이 true일 때 반복 수행할 코드 } 초기식 : for문을 제어하는 용도의 변수 선언
	 * 
	 * 조건식 : for문의 반복 여부를 지정하는 식 조건식이 true인 경우에 반복을 수행함 보통 초기식에 사용된 변수를 이용해서 조건식을
	 * 작성함.
	 * 
	 * 증감식 : for문이 끝날 때 마다 특정 값을 변화 시키는 식 보통 초기식에 사용된 변수를 증가/감소 시켜 조건식의 결과를 변화게 만듦.
	 * 
	 * 
	 */
